        ...
        >
          <div className="w-full h-[48px] rounded  py-3 flex mt-2 justify-between items-center">
            <div className="flex gap-2 items-center">
              <input
                {...register(getData[3])}
                className="flex-1 outline-none placeholder:text-neutral-500 text-[16px] appearance-none border-[#94A3B8] checked:border-accent1 checked:border-[3px] sm:checked:border-[6px] w-3 h-3 sm:w-5 sm:h-5 border-[1.5px]  rounded-full"
                type="radio"
                name={getData[3]}
                id={"inside"}
                value="60"
              ...
              <label
                htmlFor={"inside"}
                className="text-white capitalize font-normal font-onest text-[12px] sm:text-[16px]"
              >
                inside Dhaka tk.60
              </label>
            </div>
            <div className="flex gap-2 items-center">
              <input
                {...register(getData[3])}
                className="flex-1 outline-none placeholder:text-neutral-500 text-[16px] appearance-none checked:border-accent1 checked:border-[3px] sm:checked:border-[6px]  w-3 h-3 sm:w-5 sm:h-5 border-[1.5px] border-[#94A3B8] rounded-full"
                type="radio"
                name={getData[3]}
                id={"outside"}
                value="120"
